...
### Sample Character Objectives
<div class="row">
  <div class="column">
    <img class="image_med" src="{{ site.baseurl }}/images/CG/Puck.png?raw=true" title="Puck" alt="Puck" style="width:100%">
  </div>
  <div class="column">
   <img class="image_med" src="{{ site.baseurl }}/images/CG/Titus.png?raw=true" title="King Lear" alt="King Lear" style="width:100%">
  </div>
</div>
...
Designer:
* Designed character objectives that encourage and offer different playstyles.
* Balanced mechanics so that it was accessible and fun to play for different types of players.
